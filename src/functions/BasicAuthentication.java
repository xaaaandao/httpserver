 ...
 * cliente tem um campo no Authorization e se o valor desse campo é o que é esperado,
 * caso haja um erro na autenticação montamos um cabeçalho com a página de erro
 * na autenticação.
...
public class BasicAuthentication {
    ...
    Socket s;
     ...
     /**
     * O método BasicAuthentication() é apenas um construtor.
    ...
    /**
     * O método hasAuthentication() verifica se na requisição do cliente
     * contém o campo Authorization se tiver verifica se o conteúdo desse campo
     * em base 64 é igual ao esperado, se sim retorna true caso contrário retorna
     * false.
     * @param buffer BufferedReader buffer enviado pelo cliente durante a requisição.
     * @return true ou falso, boolean true caso tenha essa autorização e falso caso 
     * não tenha essa autorização.
     * @throws IOException
     */
    ...
    /**
     * O método responseAuthentication() monta um cabeçalho de resposta ao cliente
     * de acesso não autorizado com uma página HTML com o erro 401 de acesso não autorizado,
     * caso não venha o valor (ou seja, o login e a senha incorreto) esperado retorna essa página. 
     * @param buffer BufferedReader buffer enviado pelo cliente durante a requisição.
     * @throws IOException
     */
